...
public class Receive<mGoogleSignInClient> extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    EditText mFullName,mDescription, maddress;
    Button mSubmitBtn;
    FirebaseAuth fAuth;
